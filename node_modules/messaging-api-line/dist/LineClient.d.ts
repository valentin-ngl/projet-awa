...
export default class LineClient {
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    reply(replyToken: string, messages: Types.Message[]): Promise<Types.MutationSuccessResponse>;
    /**
     * Reply Message
     *
     * Sends a reply message in response to an event from a user, group, or room.
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    replyMessages(replyToken: string, messages: Types.Message[]): Promise<Types.MutationSuccessResponse>;
    /**
     * Reply Text Message
     *
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    replyCarouselTemplate(replyToken: string, altText: string, columns: Types.ColumnObject[], options?: Types.CarouselTemplateOptions): Promise<Types.MutationSuccessResponse>;
    /**
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    push(to: string, messages: Types.Message[]): Promise<Types.MutationSuccessResponse>;
    /**
     * Push Message
     *
     * Sends a push message to a user, group, or room at any time.
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    pushMessages(to: string, messages: Types.Message[]): Promise<Types.MutationSuccessResponse>;
    /**
     * Push Text Message
     *
     * [Official document - text message](https://developers.line.biz/en/reference/messaging-api/#text-message)
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    pushCarouselTemplate(to: string, altText: string, columns: Types.ColumnObject[], options?: Types.CarouselTemplateOptions): Promise<Types.MutationSuccessResponse>;
    /**
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    multicast(to: string[], messages: Types.Message[]): Promise<Types.MutationSuccessResponse>;
    /**
     * Multicast Message
     *
     * Sends push messages to multiple users at any time. Messages cannot be sent to groups or rooms.
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    multicastMessages(to: string[], messages: Types.Message[]): Promise<Types.MutationSuccessResponse>;
    /**
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    multicastCarouselTemplate(to: string[], altText: string, columns: Types.ColumnObject[], options?: Types.CarouselTemplateOptions): Promise<Types.MutationSuccessResponse>;
    /**
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    linkRichMenu(userId: string, richMenuId: string): Promise<Types.MutationSuccessResponse>;
    /**
     * Unlink Rich Menu
     *
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    setDefaultRichMenu(richMenuId: string): Promise<Types.MutationSuccessResponse>;
    /**
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    uploadRichMenuImage(richMenuId: string, image: Buffer): Promise<Types.MutationSuccessResponse>;
    /**
     ...
     * - LIFF app ID
     */
    createLiffApp(liffApp: Types.LiffApp): Promise<{
        liffId: string;
    }>;
    /**
     ...
     * For more information on how to check the status of a narrowcast message, see [Get narrowcast message status](https://developers.line.biz/en/reference/messaging-api/#get-narrowcast-progress-status).
     */
    narrowcast(messages: Types.Message[], options?: Types.NarrowcastOptions): Promise<{
        requestId: string;
    }>;
    /**
     * Send Narrowcast Message
     ...
     * For more information on how to check the status of a narrowcast message, see [Get narrowcast message status](https://developers.line.biz/en/reference/messaging-api/#get-narrowcast-progress-status).
     */
    narrowcastMessages(messages: Types.Message[], options?: Types.NarrowcastOptions): Promise<{
        requestId: string;
    }>;
    /**
     ...
     */
    createImpAudienceGroup(description: string, requestId: string): Promise<Types.ImpAudienceGroup>;
    /**
     ...
     * @returns Returns the `200` HTTP status code.
     */
    deleteAudienceGroup(audienceGroupId: number): Promise<Types.MutationSuccessResponse>;
    /**
     * Get Audience Group
     *
     * Gets audience data.
     ...
     */
    getAudienceGroup(audienceGroupId: number): Promise<Types.AudienceGroupWithJob>;
    /**
     * Get Audience Groups
     *
     ...
     */
    changeAudienceGroupAuthorityLevel(authorityLevel: 'PUBLIC' | 'PRIVATE'): Promise<Types.MutationSuccessResponse>;
}
